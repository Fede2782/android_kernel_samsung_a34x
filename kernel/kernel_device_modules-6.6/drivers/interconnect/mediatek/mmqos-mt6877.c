...
#include "mmqos-mtk.h"
static const struct mtk_node_desc node_descs_mt6877[] = {
	...
	DEFINE_MNODE(larb21, SLAVE_LARB(21), 0, false, 0x1, MASTER_COMMON_PORT(0, 8)), //virt disp
	DEFINE_MNODE(larb22, SLAVE_LARB(22), 0, true, 0x1, MASTER_COMMON_PORT(0, 7)), //virt ccu0
	DEFINE_MNODE(larb23, SLAVE_LARB(23), 0, true, 0x2, MASTER_COMMON_PORT(0, 6)), //virt ccu1
	/* LARB0 */
	...
	DEFINE_MNODE(ovl_2L_rdma1_hdr,
		MASTER_LARB_PORT(M4U_PORT_L1_OVL_2L_RDMA1_HDR), 7, false, 0x2, SLAVE_LARB(1)),
	DEFINE_MNODE(ovl_2l_rdma1,
		MASTER_LARB_PORT(M4U_PORT_L1_OVL_2L_RDMA1), 8, false, 0x2, SLAVE_LARB(1)),
	/* LARB2 */
	...
	DEFINE_MNODE(padi0,
		MASTER_LARB_PORT(M4U_PORT_L13_CAM_PADI0), 7, false, 0x2, SLAVE_LARB(13)),
	DEFINE_MNODE(padi1,
		MASTER_LARB_PORT(M4U_PORT_L13_CAM_PADI1), 8, true, 0x2, SLAVE_LARB(13)),
	DEFINE_MNODE(pdao,
		MASTER_LARB_PORT(M4U_PORT_L13_CAM_PDAO), 7, false, 0x2, SLAVE_LARB(13)),
	/* LARB14 */
	DEFINE_MNODE(mrawi,
	...
	DEFINE_MNODE(camsv7,
		MASTER_LARB_PORT(M4U_PORT_L14_CAMSV7), 8, true, 0x1, SLAVE_LARB(14)),
	DEFINE_MNODE(camsv8,
		MASTER_LARB_PORT(M4U_PORT_L14_CAMSV8), 8, true, 0x1, SLAVE_LARB(14)),
	DEFINE_MNODE(camsv9,
		MASTER_LARB_PORT(M4U_PORT_L14_CAMSV9), 7, false, 0x1, SLAVE_LARB(14)),
	DEFINE_MNODE(camsv10,
		MASTER_LARB_PORT(M4U_PORT_L14_CAMSV10), 8, true, 0x1, SLAVE_LARB(14)),
	/* LARB16 */
...
static const char * const comm_muxes_mt6877[] = { "mm" };
static const char * const comm_icc_path_names_mt6877[] = { "icc-bw" };
static const char * const comm_icc_hrt_path_names_mt6877[] = { "icc-hrt-bw" };
static const char * const larb_icc_path_names_mt6877[] = { "larb0", "larb1", "larb2", NULL,
	"larb4", NULL, NULL, "larb7", NULL, "larb9", NULL, "larb11", NULL, "larb13", "larb14",
	NULL, "larb16", "larb17", NULL, "larb19", "larb20", NULL, NULL, NULL };
static const struct mtk_mmqos_desc mmqos_desc_mt6877 = {
	.nodes = node_descs_mt6877,
	.num_nodes = ARRAY_SIZE(node_descs_mt6877),
	.comm_muxes = comm_muxes_mt6877,
	.comm_icc_path_names = comm_icc_path_names_mt6877,
	.comm_icc_hrt_path_names = comm_icc_hrt_path_names_mt6877,
	...
	.hrt = {
		.hrt_bw = {5272, 0, 0},
		.hrt_total_bw = 25600, /* Todo: Use DRAMC API */
		.md_speech_bw = { 5272, 5272},
		.hrt_ratio = {1000, 860, 880, 1000},
		.blocking = true,
		.emi_ratio = 680,
	},
	.comm_port_channels = {
		{ 0x1, 0x2, 0x2, 0x1, 0x1, 0x2, 0x2, 0x1, 0x3}
	},
	.comm_port_hrt_types = {
...
static const struct of_device_id mtk_mmqos_mt6877_of_ids[] = {
{
.compatible = "mediatek,mt6877-mmqos",
.data = &mmqos_desc_mt6877,
},
{}
};
MODULE_DEVICE_TABLE(of, mtk_mmqos_mt6877_of_ids);
static struct platform_driver mtk_mmqos_mt6877_driver = {
.probe = mtk_mmqos_probe,
.remove = mtk_mmqos_remove,
.driver = {
.name = "mtk-mt6877-mmqos",
.of_match_table = mtk_mmqos_mt6877_of_ids,
},
};
module_platform_driver(mtk_mmqos_mt6877_driver);
MODULE_LICENSE("GPL");
