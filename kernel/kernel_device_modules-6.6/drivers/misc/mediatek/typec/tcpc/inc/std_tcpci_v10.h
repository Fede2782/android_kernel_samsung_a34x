...
#define TCPC_V10_REG_ALERT_VBUS_SINK_DISCONNECT		(1<<11)
#define TCPC_V10_REG_ALERT_RX_OVERFLOW			(1<<10)
...
#define TCPC_V10_REG_ALERT_RX_ALL_MASK	\
	(TCPC_V10_REG_ALERT_RX_STATUS | TCPC_V10_REG_ALERT_RX_OVERFLOW | \
	 TCPC_V10_REG_ALERT_RX_HARD_RST)

#define TCPC_V10_REG_ALERT_HRESET_SUCCESS	\
	(TCPC_V10_REG_ALERT_TX_SUCCESS | TCPC_V10_REG_ALERT_TX_FAILED)

#define TCPC_V10_REG_ALERT_TX_MASK (TCPC_V10_REG_ALERT_TX_SUCCESS | \
	TCPC_V10_REG_ALERT_TX_FAILED | TCPC_V10_REG_ALERT_TX_DISCARDED)
...
#define TCPC_V20_REG_FAULT_STATUS_RESET_TO_DEFAULT	(1<<7)
