...
static struct lpm_spm_wake_status mt6781_wakesrc;

static struct lpm_log_helper mt6781_log_help = {
	.wakesrc = &mt6781_wakesrc,
	.cur = 0,
	.prev = 0,
};
...
{
	struct lpm_log_helper *help = &mt6781_log_help;
...
{
	struct lpm_spm_wake_status *wakesrc = mt6781_log_help.wakesrc;
...
static struct lpm_dbg_plat_ops mt6781_dbg_ops = {
...
int mt6781_dbg_ops_register(void)
{
	int ret;

	mt6781_log_help.wakesrc->gpio200_datain =
			LPM_DBG_SMC(MT_SPM_DBG_SMC_UID_RC_GPIO200_DATAIN,
			MT_LPM_SMC_ACT_GET, 0, 0);

	ret = lpm_dbg_plat_ops_register(&mt6781_dbg_ops);
