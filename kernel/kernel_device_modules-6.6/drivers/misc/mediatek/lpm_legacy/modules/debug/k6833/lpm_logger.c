...
static struct lpm_spm_wake_status mt6833_wakesrc;

static struct lpm_log_helper mt6833_log_help = {
	.wakesrc = &mt6833_wakesrc,
	.cur = 0,
	.prev = 0,
};
...
{
	struct lpm_log_helper *help = &mt6833_log_help;
...
{
	struct lpm_spm_wake_status *wakesrc = mt6833_log_help.wakesrc;
...
static struct lpm_dbg_plat_ops mt6833_dbg_ops = {
...
int dbg_ops_register(void)
{
	...
	ret = lpm_dbg_plat_ops_register(&mt6833_dbg_ops);
