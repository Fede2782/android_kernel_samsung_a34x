...
#define XTC_I2C_BURST_BUFFER_LEN 1400
 ...
 */
	...
	case SENSOR_FEATURE_GET_PIXEL_RATE:
		...
		case MSDK_SCENARIO_ID_CUSTOM4:
			...
			*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = (imgsensor_info.custom4.pclk /
			...
			break;
		case MSDK_SCENARIO_ID_CUSTOM5:
			LOG_INF("MSDK_SCENARIO_ID_CUSTOM5 = %llu\n", *feature_data);
			*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = (imgsensor_info.custom5.pclk /
			...
			break;
		case MSDK_SCENARIO_ID_CUSTOM6:
			LOG_INF("MSDK_SCENARIO_ID_CUSTOM6 = %llu\n", *feature_data);
	...
	case SENSOR_FEATURE_GET_BINNING_TYPE:
		...
		LOG_INF("scenario_id=%llu, binning_type=%d\n", *(feature_data + 1), *feature_return_para_32);
		*feature_para_len = 4;
		break;
	...
	case SENSOR_FEATURE_GET_RAWBIT_BY_SCENARIO:
		{
			...
			case MSDK_SCENARIO_ID_CUSTOM6:
				*(feature_data+1) = RAW_SENSOR_10BIT;
				LOG_INF("scenario_id %llu: RAW10\n", *(feature_data));
				break;
			default:
				*(feature_data+1) = RAW_SENSOR_ERROR;
				LOG_ERR("Invalid scenario id: %llu\n", *(feature_data));
				break;
			}
		}
		break;
*/
	case SENSOR_FEATURE_SET_FAST_CHANGE_MODE:
		LOG_INF("Fast Change Mode:%llu", *feature_data);
#ifdef USE_RAW12
