...
const struct adsp_core_description mt6983_adsp_c0_desc = {
	...
	.sharedmems = {
		...
		[ADSP_SHAREDMEM_C2C_BUFINFO] = {0x2514, 0x000C},
		[ADSP_SHAREDMEM_TIMESYNC] = {0x2534, 0x0020},
		[ADSP_SHAREDMEM_DVFSSYNC] = {0x2540, 0x000C},
		[ADSP_SHAREDMEM_SLEEPSYNC] = {0x2544, 0x0004},
		[ADSP_SHAREDMEM_BUS_MON_DUMP] = {0x2600, 0x00BC},
		[ADSP_SHAREDMEM_INFRA_BUS_DUMP] = {0x26A0, 0x00A0},
		[ADSP_SHAREDMEM_LATMON_DUMP] = {0x26BC, 0x001C},
	},
	.ops = {
