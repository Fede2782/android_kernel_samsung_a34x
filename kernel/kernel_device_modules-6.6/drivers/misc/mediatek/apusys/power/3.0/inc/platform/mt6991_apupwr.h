...
#ifndef __MT6991_APUPWR_H__
#define __MT6991_APUPWR_H__
...
// mt6373_vbuck2 (in mt6991 for vapu)
...
// mt6363_vbuck4 (in mt6991 for vsram_core)
...
// apu hw sema (in MBOX)
#define APU_MBOX_SEMA_CTRL0             0xA0

static inline int mt6991_all_on(struct platform_device *pdev,
	struct apu_power *papw) { return 0; }
static inline void mt6991_all_off(struct platform_device *pdev) {}
#endif // __MT6991_APUPWR_H__
