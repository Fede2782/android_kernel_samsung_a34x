...
static char *pwr_ctrl_str[PW_MAX_COUNT] = {
	...
	[PW_REG_APIFR_MEM_DDREN_REQ_MASK_B] = "reg_apifr_mem_ddren_req_mask_b",
	...
	[PW_REG_AUDIO_DDREN_REQ_MASK_B] = "reg_audio_ddren_req_mask_b",
	[PW_REG_AUDIO_EMI_REQ_MASK_B] = "reg_audio_emi_req_mask_b",
	...
	[PW_REG_CKSYS_APSRC_REQ_MASK_B] = "reg_cksys_apsrc_req_mask_b",
	[PW_REG_CKSYS_DDREN_REQ_MASK_B] = "reg_cksys_ddren_req_mask_b",
	[PW_REG_CKSYS_EMI_REQ_MASK_B] = "reg_cksys_emi_req_mask_b",
	[PW_REG_CKSYS_INFRA_REQ_MASK_B] = "reg_cksys_infra_req_mask_b",
	[PW_REG_CKSYS_PMIC_REQ_MASK_B] = "reg_cksys_pmic_req_mask_b",
	[PW_REG_CKSYS_SRCCLKENA_MASK_B] = "reg_cksys_srcclkena_mask_b",
	[PW_REG_CKSYS_VCORE_REQ_MASK_B] = "reg_cksys_vcore_req_mask_b",
	[PW_REG_CKSYS_VRF18_REQ_MASK_B] = "reg_cksys_vrf18_req_mask_b",
	[PW_REG_CKSYS_1_APSRC_REQ_MASK_B] = "reg_cksys_1_apsrc_req_mask_b",
	[PW_REG_CKSYS_1_DDREN_REQ_MASK_B] = "reg_cksys_1_ddren_req_mask_b",
	[PW_REG_CKSYS_1_EMI_REQ_MASK_B] = "reg_cksys_1_emi_req_mask_b",
	[PW_REG_CKSYS_1_INFRA_REQ_MASK_B] = "reg_cksys_1_infra_req_mask_b",
	[PW_REG_CKSYS_1_PMIC_REQ_MASK_B] = "reg_cksys_1_pmic_req_mask_b",
	[PW_REG_CKSYS_1_SRCCLKENA_MASK_B] = "reg_cksys_1_srcclkena_mask_b",
	[PW_REG_CKSYS_1_VCORE_REQ_MASK_B] = "reg_cksys_1_vcore_req_mask_b",
	[PW_REG_CKSYS_1_VRF18_REQ_MASK_B] = "reg_cksys_1_vrf18_req_mask_b",

	/* SPM_SRC_MASK_6 */
	[PW_REG_CKSYS_2_APSRC_REQ_MASK_B] = "reg_cksys_2_apsrc_req_mask_b",
	[PW_REG_CKSYS_2_DDREN_REQ_MASK_B] = "reg_cksys_2_ddren_req_mask_b",
	[PW_REG_CKSYS_2_EMI_REQ_MASK_B] = "reg_cksys_2_emi_req_mask_b",
	[PW_REG_CKSYS_2_INFRA_REQ_MASK_B] = "reg_cksys_2_infra_req_mask_b",
	[PW_REG_CKSYS_2_PMIC_REQ_MASK_B] = "reg_cksys_2_pmic_req_mask_b",
	[PW_REG_CKSYS_2_SRCCLKENA_MASK_B] = "reg_cksys_2_srcclkena_mask_b",
	[PW_REG_CKSYS_2_VCORE_REQ_MASK_B] = "reg_cksys_2_vcore_req_mask_b",
	[PW_REG_CKSYS_2_VRF18_REQ_MASK_B] = "reg_cksys_2_vrf18_req_mask_b",
	...
	[PW_REG_CORECFG_RSV0_APSRC_REQ_MASK_B] = "reg_corecfg_rsv0_apsrc_req_mask_b",
	[PW_REG_CORECFG_RSV0_DDREN_REQ_MASK_B] = "reg_corecfg_rsv0_ddren_req_mask_b",
	[PW_REG_CORECFG_RSV0_EMI_REQ_MASK_B] = "reg_corecfg_rsv0_emi_req_mask_b",
	[PW_REG_CORECFG_RSV0_INFRA_REQ_MASK_B] = "reg_corecfg_rsv0_infra_req_mask_b",
	[PW_REG_CORECFG_RSV0_PMIC_REQ_MASK_B] = "reg_corecfg_rsv0_pmic_req_mask_b",
	[PW_REG_CORECFG_RSV0_SRCCLKENA_MASK_B] = "reg_corecfg_rsv0_srcclkena_mask_b",
	[PW_REG_CORECFG_RSV0_VCORE_REQ_MASK_B] = "reg_corecfg_rsv0_vcore_req_mask_b",
	[PW_REG_CORECFG_RSV0_VRF18_REQ_MASK_B] = "reg_corecfg_rsv0_vrf18_req_mask_b",
	...
	[PW_REG_EMISYS_INFRA_REQ_MASK_B] = "reg_emisys_infra_req_mask_b",
	[PW_REG_EMISYS_PMIC_REQ_MASK_B] = "reg_emisys_pmic_req_mask_b",
	[PW_REG_EMISYS_SRCCLKENA_MASK_B] = "reg_emisys_srcclkena_mask_b",
	[PW_REG_EMISYS_VCORE_REQ_MASK_B] = "reg_emisys_vcore_req_mask_b",
	[PW_REG_EMISYS_VRF18_REQ_MASK_B] = "reg_emisys_vrf18_req_mask_b",
	...
	[PW_REG_GCE_VCORE_REQ_MASK_B] = "reg_gce_vcore_req_mask_b",
	...
	[PW_REG_INFRASYS_PMIC_REQ_MASK_B] = "reg_infrasys_pmic_req_mask_b",
	[PW_REG_INFRASYS_SRCCLKENA_MASK_B] = "reg_infrasys_srcclkena_mask_b",
	[PW_REG_INFRASYS_VCORE_REQ_MASK_B] = "reg_infrasys_vcore_req_mask_b",
	...
	[PW_REG_PMSR_APSRC_REQ_MASK_B] = "reg_pmsr_apsrc_req_mask_b",

	/* SPM_SRC_MASK_13 */
	[PW_REG_PMSR_DDREN_REQ_MASK_B] = "reg_pmsr_ddren_req_mask_b",
	[PW_REG_PMSR_EMI_REQ_MASK_B] = "reg_pmsr_emi_req_mask_b",
	[PW_REG_PMSR_INFRA_REQ_MASK_B] = "reg_pmsr_infra_req_mask_b",
	[PW_REG_PMSR_PMIC_REQ_MASK_B] = "reg_pmsr_pmic_req_mask_b",
	[PW_REG_PMSR_SRCCLKENA_MASK_B] = "reg_pmsr_srcclkena_mask_b",
	[PW_REG_PMSR_VCORE_REQ_MASK_B] = "reg_pmsr_vcore_req_mask_b",
	[PW_REG_PMSR_VRF18_REQ_MASK_B] = "reg_pmsr_vrf18_req_mask_b",
	...
	[PW_REG_SSRSYS_VCORE_REQ_MASK_B] = "reg_ssrsys_vcore_req_mask_b",
	[PW_REG_SSRSYS_VRF18_REQ_MASK_B] = "reg_ssrsys_vrf18_req_mask_b",
	[PW_REG_SSUSB_APSRC_REQ_MASK_B] = "reg_ssusb_apsrc_req_mask_b",
	[PW_REG_SSUSB_DDREN_REQ_MASK_B] = "reg_ssusb_ddren_req_mask_b",
	[PW_REG_SSUSB_EMI_REQ_MASK_B] = "reg_ssusb_emi_req_mask_b",
	[PW_REG_SSUSB_INFRA_REQ_MASK_B] = "reg_ssusb_infra_req_mask_b",
	[PW_REG_SSUSB_PMIC_REQ_MASK_B] = "reg_ssusb_pmic_req_mask_b",
	[PW_REG_SSUSB_SRCCLKENA_MASK_B] = "reg_ssusb_srcclkena_mask_b",
	[PW_REG_SSUSB_VCORE_REQ_MASK_B] = "reg_ssusb_vcore_req_mask_b",
	[PW_REG_SSUSB_VRF18_REQ_MASK_B] = "reg_ssusb_vrf18_req_mask_b",
...
struct subsys_req plat_subsys_req[] = {
	{"md", SPM_REQ_STA_10, (0x3F << 26), SPM_REQ_STA_11, 0x7, 0},
	{"conn", SPM_REQ_STA_6, 0x1FF, 0, 0, 0},
	{"disp", SPM_REQ_STA_7, (0x3FFF << 8), 0, 0, 0},
	{"scp", SPM_REQ_STA_13, (0xFF << 7), 0, 0, 0},
	{"adsp", SPM_REQ_STA_1, 0xFF, 0, 0, 0},
	{"ufs", SPM_REQ_STA_15, (0xFF << 4), 0, 0, 0},
	{"apu", SPM_REQ_STA_0, (0xFF << 8), 0, 0, 0},
	{"mm_proc", SPM_REQ_STA_11, (0xFF << 3), 0, 0, 0},
...
static int lpm_get_wakeup_status(void)
{
	...
	(((plat_mmio_read(SPM_REQ_STA_4) >> SPM_HW_CG_CHECK_SHIFT_0) & SPM_HW_CG_CHECK_MASK_0) |
	(plat_mmio_read(SPM_REQ_STA_5) & SPM_HW_CG_CHECK_MASK_1));
...
#undef LOG_BUF_SIZE
	...
	if (wakesrc->is_abort != 0) {
		...
		if (wakesrc->r12 & R12_TWAM_PMSR_DVFSRC_OCLA) {
		...
		log_size += scnprintf(log_buf + log_size,
			...
			wakesrc->req_sta15, wakesrc->req_sta16);
...
static int __init mt6991_dbg_device_initcall(void)
{
	int ret;
...
static int __init mt6991_dbg_late_initcall(void)
{
...
int __init mt6991_dbg_init(void)
{
	int ret = 0;

	ret = mt6991_dbg_device_initcall();
	if (ret)
		goto mt6991_dbg_init_fail;

	ret = mt6991_dbg_late_initcall();
	if (ret)
		goto mt6991_dbg_init_fail;

	return 0;

mt6991_dbg_init_fail:
	return -EAGAIN;
}

void __exit mt6991_dbg_exit(void)
{
...
module_init(mt6991_dbg_init);
module_exit(mt6991_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("mt6991 low power debug module");
