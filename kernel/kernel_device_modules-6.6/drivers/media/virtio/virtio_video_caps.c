					      ...
					      void *buf)
{
	...
	frame->reserved[0] = le32_to_cpu(virtio_frame->reserved[0]);
	frame->reserved[1] = le32_to_cpu(virtio_frame->reserved[1]);
	frame->reserved[2] = le32_to_cpu(virtio_frame->reserved[2]);
#endif
