...
enum mtk_drm_dataspace {
	...
	MTK_DRM_DATASPACE_BT2020_ITU = 281411584,
	/* ((STANDARD_BT2020 | TRANSFER_ST2084) | RANGE_LIMITED) */
	MTK_DRM_DATASPACE_BT2020_ITU_PQ = 298188800,
	/* ((STANDARD_BT2020 | TRANSFER_HLG) | RANGE_LIMITED) */
	MTK_DRM_DATASPACE_BT2020_ITU_HLG = 302383104,
	/* ((STANDARD_BT2020 | TRANSFER_HLG) | RANGE_FULL) */
	MTK_DRM_DATASPACE_BT2020_HLG = 168165376,
	/* ((STANDARD_BT2020 | TRANSFER_SRGB) | RANGE_FULL) */
	MTK_DRM_DATASPACE_DISPLAY_BT2020 = 142999552,
	MTK_DRM_DATASPACE_DYNAMIC_DEPTH = 4098,
	MTK_DRM_DATASPACE_JPEG_APP_SEGMENTS = 4099,
	MTK_DRM_DATASPACE_HEIF = 4100,
};
...
enum mtk_drm_color_mode {
	...
	MTK_DRM_COLOR_MODE_BT2020 = 10,
	MTK_DRM_COLOR_MODE_BT2100_PQ = 11,
	MTK_DRM_COLOR_MODE_BT2100_HLG = 12,
	MTK_DRM_COLOR_MODE_DISPLAY_BT2020 = 13,
};
