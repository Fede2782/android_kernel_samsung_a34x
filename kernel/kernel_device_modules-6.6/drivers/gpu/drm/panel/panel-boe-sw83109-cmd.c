...
static struct LCM_setting_table init_setting_cmd[] = {
    ...
    {13,  {0x30, 0x00, 0x00, 0x09, 0x5F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
    {5,   {0x31, 0x00, 0x00, 0x04, 0x37}},
    {2,   {0x35, 0x00}},
    {2,   {0x4D, 0x19}},
    {3,   {0x3D, 0x00, 0X01}},
	{3,	  {0x53, 0x00, 0X00}},
    {17,  {0x55, 0x08, 0x00, 0x00, 0x00, 0x10, 0x00, 0x10, 0x00, 0x10, 0x00, 0x72, 0xD0, 0x1C, 0x70, 0xD0, 0xE1}},
	{3,	  {0x68, 0x0B, 0x02}},
	...
	{2,	  {0xB0, 0xA4}},
	{46,  {0xB1, 0x07, 0xF4, 0xFF, 0x3F, 0xFF, 0x3F, 0x7F, 0x87, 0x20, 0x80, 0x68, 0x88, 0x68, 0x89, 0x89, 0x69, 0x2F, 0xFF, 0x4F, 0xFF, 0x6E, 0xEE, 0xC8, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x24, 0xFF, 0xFF, 0x04, 0x04, 0x00, 0x37, 0x09, 0x00, 0x5F, 0xC0, 0xC0, 0x20}},
	{2,	  {0xB0, 0xA1}},
	{14,  {0xF0, 0x32, 0x03, 0x59, 0x03, 0x5B, 0x03, 0x35, 0x03, 0x37, 0x80, 0xC4, 0x01, 0x00}},
	{2,	  {0xB0, 0xA7}},
	{3,	  {0xB1, 0xE0, 0x00}},
	{2,	  {0xB0, 0xCA}},
	{2,	  {0x57, 0x01}},
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	push_table(ctx, init_setting_cmd, sizeof(init_setting_cmd) / sizeof(struct LCM_setting_table));
}
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (stage == AFTER_DSI_POWERON) {
		push_table(ctx, mode_switch_60_to_120_cmd, sizeof(mode_switch_60_to_120_cmd) / sizeof(struct LCM_setting_table));
	}
}
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (stage == AFTER_DSI_POWERON) {
		push_table(ctx, mode_switch_120_to_60_cmd, sizeof(mode_switch_120_to_60_cmd) / sizeof(struct LCM_setting_table));
	}
}
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("[%s][sw83109] call lcm_panel_bias_regulator_init\n", __func__);
	lcm_panel_bias_regulator_init();
	lcm_panel_bias_enable();
