...
struct mipi_dsi_lcd_driver *mipi_lcd_driver = &name;	\
...
//core_initcall
extern int smcdsd_board_init(void);
extern int smcdsd_notifier_init(void);
//late_initcall
extern int smcdsd_board_late_initcall(void);
extern int smcdsd_abd_init(void);
extern int dd_lcd_init(void);
extern int panel_late_init(void);
...
extern int mtk_drm_uevent_trigger(int state);

struct cmdq_pkt;
extern int read_lcm_wrapper(struct cmdq_pkt *handle, struct mtk_ddic_dsi_msg *cmd_msg);
extern int set_lcm_wrapper(struct cmdq_pkt *handle, struct mtk_ddic_dsi_msg *cmd_msg, int blocking);
#endif
