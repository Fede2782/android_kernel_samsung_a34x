...
#define TZCH_PAGES_COUNT 14

static char tzch_buf[TZCH_PAGES_COUNT * PAGE_SIZE] __aligned(PAGE_SIZE);
...
static long tz_chtest_drv_unlocked_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case IOCTL_CUSTOM_HANDLER_CMD:
		...
		LOG_DBG("Regs before : r0 = 0x%08x, r1, = 0x%08x, r2 = 0x%08x, r3 = 0x%08x, r4 = 0x%08x, r5 = 0x%08x\n",
		...
		LOG_DBG("Regs after  : r0 = 0x%08x, r1, = 0x%08x, r2 = 0x%08x, r3 = 0x%08x, r4 = 0x%08x, r5 = 0x%08x\n",
			chtest_data.r0, chtest_data.r1, chtest_data.r2, chtest_data.r3, chtest_data.r4, chtest_data.r5);
...
{
	int ret = 0;
	tzch_buf_phys = virt_to_phys(tzch_buf);
