...
#define MAP_SIZE	0x1000
	...
	|| defined(CONFIG_MACH_MT6757) || defined(CONFIG_MACH_MT6768)
...
static const struct file_operations tzpc_test_fops = {
	.open = tzpc_test_open,
...
tzdev_initcall(tzpc_test_init);
tzdev_exitcall(tzpc_test_exit);
