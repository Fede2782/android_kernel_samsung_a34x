...
static ssize_t gyroscope_lsm6dsl_selftest(int type, char *buf)
{
	char *temp_buf = NULL;
...
struct gyroscope_factory_chipset_funcs gyroscope_lsm6dsl_ops = {
	.selftest = gyroscope_lsm6dsl_selftest,
};
