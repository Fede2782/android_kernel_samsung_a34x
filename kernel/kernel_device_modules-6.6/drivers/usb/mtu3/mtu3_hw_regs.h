...
/* USB GLK GATE */
#define U3D_CLKGATE		0x0000
#define REQ_GATE0		0x70
#define REQ_GATE1		0x74
#define REQ_GATE2		0x78
#define REQ_GATE3		0x7C
#define REQ_GATE4		0x80
...
#define U3D_GEN2_POLLING_SCDLFPS_TIME		(SSUSB_USB3_MAC_CSR_BASE + 0x00EC)
...
#define RX_UX_EXIT_LFPS_GEN2_PIPE_MASK  GENMASK(23, 16)
#define RX_UX_EXIT_LFPS_GEN2_PIPE(x)    (((x) & 0xff) << 16)
#define RX_UX_EXIT_LFPS_PIPE_MASK       GENMASK(7, 0)
#define RX_UX_EXIT_LFPS_PIPE(x)         ((x) & RX_UX_EXIT_LFPS_PIPE_MASK)

/* U3D_GEN2_POLLING_SCDLFPS_TIME */
#define POLLING_SCDLFPS_TIME_MASK       GENMASK(6, 0)
#define POLLING_SCDLFPS_TIME(x)      ((x) & POLLING_SCDLFPS_TIME_MASK)
...
#define U3D_RESPONSER_LDM	(SSUSB_USB3_SYS_CSR_BASE + 0x0280)
...
/* U3D_RESPONSER_LDM */
#define REG_LDM_RESP_DELAY	GENMASK(29, 16)
#define LDM_RESP_DELAY(x)	(((x) & 0x3fff) << 16)
...
#define LPM_L1_RESIDENCY_MSK	GENMASK(11, 0)
#define LPM_L1_RESIDENCY(x)	((x) & LPM_L1_RESIDENCY_MSK)

/* U3D_USB20_OPSTATE */
#define OPM_A_WRCON		0x21
...
#define U3D_SSUSB_SPM_CTRL_V2      (SSUSB_SIFSLV_IPPC_BASE + 0x00E0)
#define U3D_SSUSB_SPM_CTRL_ACK_V2  (SSUSB_SIFSLV_IPPC_BASE + 0x00E8)
...
#define SSUSB_SPM_HW_SHIFT		8
#define SSUSB_SPM_HW_PMIC_EN		BIT(15)
#define SSUSB_SPM_HW_EMI_REQ		BIT(14)
#define SSUSB_SPM_HW_VCORE_EN		BIT(13)
#define SSUSB_SPM_HW_DDREN_REQ		BIT(12)
#define SSUSB_SPM_HW_VRF18_REQ		BIT(11)
#define SSUSB_SPM_HW_APSRC_REQ		BIT(10)
#define SSUSB_SPM_HW_INFRE_REQ		BIT(9)
#define SSUSB_SPM_HW_SRCCLKENA		BIT(8)
...
#define SSUSB_SPM_REQ_OFFLOAD_MSK \
	(SSUSB_SPM_SRCCLKENA | SSUSB_SPM_INFRE_REQ | \
	SSUSB_SPM_VRF18_REQ | SSUSB_SPM_VCORE_EN)
#define SSUSB_SPM_REQ_OFFLOAD_IDLE_MSK \
	(SSUSB_SPM_SRCCLKENA | SSUSB_SPM_INFRE_REQ | \
	SSUSB_SPM_VRF18_REQ | SSUSB_SPM_VCORE_EN | \
	SSUSB_SPM_HW_APSRC_REQ | SSUSB_SPM_HW_DDREN_REQ | \
	SSUSB_SPM_HW_EMI_REQ)
...
#define SSUSB_IP_MAC_U3_PORT_NO			(0xff << 0)
#define SSUSB_IP_MAC_U3_SPEED_CAP_MSK	GENMASK(18, 16)
#define SSUSB_IP_MAC_U3_SPEED_CAP_OFST	(16)
#define SSUSB_IP_MAC_U3_SPEED_GEN2X2    (0x11)
#define SSUSB_IP_MAC_U3_SPEED_GEN1X2    (0x10)
#define SSUSB_IP_MAC_U3_SPEED_GEN2X1    (0x01)
#define SSUSB_IP_MAC_U3_SPEED_GEN1X1    (0x00)
