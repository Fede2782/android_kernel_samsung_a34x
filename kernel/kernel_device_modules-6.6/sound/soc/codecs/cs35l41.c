				...
				struct snd_soc_component *component)
{
	...
	mtk_spk_set_type(MTK_SPK_CIRRUS_CS35L41);
#endif
	return 0;
}
...
static int cs35l41_dsp_init(struct cs35l41_private *cs35l41)
{
	...
	if (cs35l41->pdata.use_fsync_errata) {
		regmap_multi_reg_write(cs35l41->regmap, cs35l41_fs_errata_patch,
...
#if IS_ENABLED(CONFIG_SND_SOC_SAMSUNG_AUDIO)
	//Speaker type set at the end of probe function same A34 VOS
	mtk_spk_set_type(MTK_SPK_CIRRUS_CS35L41);
#endif
err:
	return ret;
...
int cs35l41_reinit(struct snd_soc_component *component)
{
	...
	mutex_lock(&cs35l41->dsp.cs_dsp.pwr_lock);
	cs35l41->dsp.cs_dsp.running = false;
	mutex_unlock(&cs35l41->dsp.cs_dsp.pwr_lock);
