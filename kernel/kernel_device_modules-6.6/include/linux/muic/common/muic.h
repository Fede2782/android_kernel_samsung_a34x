...
struct muic_platform_data {
	...
	/* muic get hiccup mode function */
	int (*muic_get_hiccup_mode_cb)(void);

	/* muic set pogo adc function */
	int (*muic_set_pogo_adc_cb)(int adc);

	/* muic set cc_high state function */
	int (*muic_set_cc_high_state_cb)(bool is_high);
...
extern int muic_get_hiccup_mode(void);
...
static inline int muic_get_hiccup_mode(void) {return 0; }
