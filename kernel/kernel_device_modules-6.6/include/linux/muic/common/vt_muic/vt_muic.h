...
#define CC_WATER_STATE	BIT(0)
#define CC_HIGH_STATE	BIT(1)
#define CC_WATER_CC_HIGH	(CC_WATER_STATE | CC_HIGH_STATE)
...
struct vt_muic_ops {
	...
	void (*set_cc_high_state)(void *mdata, int state, bool en);
};
...
extern void vt_muic_set_water_state(int state, bool en);
...
static inline int vt_muic_get_afc_disable(void)
	{return 0; }
static inline void vt_muic_set_water_state(int state, bool en) {return; }
