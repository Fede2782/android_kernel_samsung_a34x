...
enum ACDK_SENSOR_FEATURE_ENUM {
	...
	SENSOR_FEATURE_SET_NIGHT_HYPERLAPSE_MODE, // SAMSUNG_MTKCAM_EXT - HAL_CMD_INTERFACE_NIGHT_HYPERLAPSE
	SENSOR_FEATURE_SET_NIGHT_HYPERLAPSE_SYNC, // SAMSUNG_MTKCAM_EXT - Night hyperlapse sync flag
	SENSOR_FEATURE_MAX
};
