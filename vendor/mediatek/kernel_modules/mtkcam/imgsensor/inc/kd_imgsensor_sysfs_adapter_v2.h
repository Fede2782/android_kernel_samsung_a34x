 ...
 ***   The adapters are made for preventing build error, when CONFIG_IMGSENSOR_SYSFS_V2 is not defined.
 ***   If CONFIG_IMGSENSOR_SYSFS_V2 is not defined, below functions do nothing or return error.
 ***
 ****************************************************************************
 ****************************************************************************/
#ifndef _KD_IMGSENSOR_SYSFS_ADAPTER_V2_H_
#define _KD_IMGSENSOR_SYSFS_ADAPTER_V2_H_
...
#endif
#endif /*_KD_IMGSENSOR_SYSFS_ADAPTER_V2_H_*/
