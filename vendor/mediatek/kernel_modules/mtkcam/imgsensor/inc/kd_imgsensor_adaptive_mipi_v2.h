...
#ifndef _KD_IMGSENSOR_ADAPTIVE_MIPI_V2_H
#define _KD_IMGSENSOR_ADAPTIVE_MIPI_V2_H
...
struct cam_mipi_sensor_mode {
	...
	struct cam_mipi_setting *sensor_setting;
...
#else
static inline int imgsensor_select_mipi_by_rf_cell_infos(const struct cam_mipi_sensor_mode *mipi_sensor_mode)
{
	return -1;
};
#endif
int imgsensor_verify_mipi_cell_ratings(const struct cam_mipi_cell_ratings *channel_list, const int size,
										const int freq_size);
...
#endif /* _KD_IMGSENSOR_ADAPTIVE_MIPI_H */
