...
#define REAR2_HI847_MAX_CAL_SIZE               (0x04FC + 0x10)
#define REAR2_HI847_HEADER_CHECKSUM_LEN        (0x0054)
#define REAR2_HI847_MODULE_DATA_CHECKSUM_LEN   (0x046B - 0x0058 + 0x01)

#define REAR2_HI847_CONVERTED_MAX_CAL_SIZE     (0x086F + 0x1) 
#define REAR2_HI847_CONVERTED_AWB_CHECKSUM_LEN (0x006F - 0x0064 + 0x1)
#define REAR2_HI847_CONVERTED_LSC_CHECKSUM_LEN (0x07CF - 0x0074 + 0x1)
...
const struct imgsensor_vendor_rom_addr rear2_hi847_cal_addr = {
	...
	.rom_header_checksum_addr               = 0x0054,
	...
	.rom_module_checksum_addr               = 0x046C,
