...
#define FRONT_OV13A10F_MAX_CAL_SIZE               (0x069B + 0x1)

#define FRONT_OV13A10F_HEADER_CHECKSUM_LEN        (0x0051 - 0x0000 + 0x1)

#define FRONT_OV13A10F_MODULE_CAL_DATA_CHECKSUM_LEN (0x0477 - 0x0056 + 0x1)

#define FRONT_OV13A10F_CONVERTED_MAX_CAL_SIZE      (0x09F3 + 0x1)
#define FRONT_OV13A10F_CONVERTED_AWB_CHECKSUM_LEN  (0x006F - 0x0064 + 0x1)
#define FRONT_OV13A10F_CONVERTED_LSC_CHECKSUM_LEN  (0x07CF - 0x0074 + 0x1)

const struct rom_converted_cal_addr front_ov13a10f_converted_cal_addr = {
	.rom_awb_cal_data_start_addr            = 0x0064,
	.rom_awb_checksum_addr                  = 0x0070,
	.rom_awb_checksum_len                   = (FRONT_OV13A10F_CONVERTED_AWB_CHECKSUM_LEN),
	.rom_shading_cal_data_start_addr        = 0x0074,
	.rom_shading_checksum_addr              = 0x07D0,
	.rom_shading_checksum_len               = (FRONT_OV13A10F_CONVERTED_LSC_CHECKSUM_LEN),
};

const struct imgsensor_vendor_rom_addr front_ov13a10f_cal_addr = {
	/* Set '-1' if not used */
	.camera_module_es_version               = 'A',
	.cal_map_es_version                     = '1',
	.rom_max_cal_size                       = FRONT_OV13A10F_MAX_CAL_SIZE,
	...
	.rom_header_checksum_len                = FRONT_OV13A10F_HEADER_CHECKSUM_LEN,
	...
	.rom_module_checksum_len                = FRONT_OV13A10F_MODULE_CAL_DATA_CHECKSUM_LEN,
	...
	.converted_cal_addr                     = &front_ov13a10f_converted_cal_addr,
	.rom_converted_max_cal_size             = FRONT_OV13A10F_CONVERTED_MAX_CAL_SIZE,

	.sensor_maker                           = "OMNIVISION",  // SENSOR_MAKER NAME
	.sensor_name                            = "OV13A10F",
