...
#ifndef _IMGSENSOR_SYSFS_V2_H_
#define _IMGSENSOR_SYSFS_V2_H_
...
unsigned int imgsensor_read_otp_cal(struct i2c_client *client, unsigned int sensor_id, unsigned int addr, unsigned char *data, unsigned int size);
...
const struct imgsensor_vendor_rom_addr *imgsensor_sys_get_rom_addr_by_id(unsigned int dualDeviceId, unsigned int sensorId);
