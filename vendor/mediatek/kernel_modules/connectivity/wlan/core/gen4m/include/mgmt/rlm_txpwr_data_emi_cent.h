...
/*! \file   "rlm_tx_pwr_config_data_emi_cen_ch.h"
 *    \brief
 */

#ifndef _RLM_TXPWR_CONFIG_DATA_EMI_CEN_CH_H
#define _RLM_TXPWR_CONFIG_DATA_EMI_CEN_CH_H
...
#endif /*_RLM_TXPWR_CONFIG_DATA_EMI_CEN_CH_H*/
