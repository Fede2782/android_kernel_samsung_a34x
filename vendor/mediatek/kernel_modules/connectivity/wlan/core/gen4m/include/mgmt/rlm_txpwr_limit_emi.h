...
enum ENUM_TX_PWR_EMI_STATUS_ACTION {
	...
	TX_PWR_EMI_STATUS_ACTION_CNM_RLM_SYNC_OP_PARAMS_START,
...
{ \
	...
	DBGLOG(RLM, INFO, \
		...
		base, g_rlmPowerLimitConfigTable[base].HE.table_num); \
}
...
{ \
	...
	DBGLOG(RLM, INFO, \
		...
		base, g_rlmPowerLimitConfigTable[base].EHT.table_num); \
}
#endif
