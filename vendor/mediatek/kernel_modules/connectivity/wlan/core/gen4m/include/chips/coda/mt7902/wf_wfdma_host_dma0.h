...
#define BASE_PTR_EXT_MASK                                                     \
		WF_WFDMA_HOST_DMA0_WPDMA_TX_RING0_CTRL1_BASE_PTR_EXT_MASK
#define BASE_PTR_EXT_SHFT                                                     \
		WF_WFDMA_HOST_DMA0_WPDMA_TX_RING0_CTRL1_BASE_PTR_EXT_SHFT
#define MAX_CNT_MASK                                                          \
		WF_WFDMA_HOST_DMA0_WPDMA_TX_RING0_CTRL1_MAX_CNT_MASK
#define MAX_CNT_SHFT                                                          \
		WF_WFDMA_HOST_DMA0_WPDMA_TX_RING0_CTRL1_MAX_CNT_SHFT
