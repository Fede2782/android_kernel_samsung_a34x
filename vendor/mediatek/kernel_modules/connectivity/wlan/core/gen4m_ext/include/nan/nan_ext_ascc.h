...
enum NAN_SCHEDULE_ENTRY_OPERATION {
	NAN_SCHEDULE_ENTRY_ADD = 0, /* DW, FAW, USD, SD, ULW, Discovery */
	NAN_SCHEDULE_ENTRY_REMOVE = 1,
	NAN_SCHEDULE_ENTRY_OVERWRITE = 2,
	NAN_SCHEDULE_ENTRY_RESET = 3,
	NAN_SCHEDULE_ENTRY_NOT_CHANGE = 4, /* DW, FAW, USD, SD, ULW */
	/* 5~6: Reserved */
	NAN_SCHEDULE_ENTRY_FAIL_TO_CHANGE = 7, /* DW, FAW, USD, SD, ULW */
};
