...
{
	uint8_t uc2Gchannel = g_r2gDwChnl.u4PrimaryChnl;
	uint8_t uc5Gchannel = g_r5gDwChnl.u4PrimaryChnl;

	uint8_t aucClearAdsdcHexCmd[] = {
		0x40, 0x2A, 0x00, 0x02, 0x01,
		0x01, 0x10, 0x01,
		0x00, 0xF0, 0x00, 0x00,
		0x0C,
		0x00, 0x00, 0x00, 0x00,
		uc2Gchannel, 0x00, 0x18,
		0x0D,
		0x00, 0x00, 0x00, 0x00,
		uc5Gchannel, 0x00, 0x18,
		0x0E,
		0x00, 0x00, 0x00, 0x00,
		uc2Gchannel, 0x18, 0x00,
		0x0F,
		0x00, 0x00, 0x00, 0x00,
		uc5Gchannel, 0x18, 0x00,
		0x03,
	};
