...
#define CB_INFRA_SLP_CTRL_CB_INFRA_PCIE_SLP_CFG0_ADDR \
	(CB_INFRA_SLP_CTRL_BASE + 0x014) // 5014
#define CB_INFRA_SLP_CTRL_CB_INFRA_PCIE_SLP_CFG1_ADDR  \
	(CB_INFRA_SLP_CTRL_BASE + 0x018) // 5018
