...
/**
* @brief Enables the CoAntVFE28 power if it is supported and currently disabled.
* [ALPS05565452] wlan: CoAnt Vfe28
* Co-ant to PIMIC porting from soc3 to soc5
*/
...
/**
* @brief Disables the CoAntVFE28 power if it is enabled.
* [ALPS05565452] wlan: CoAnt Vfe28
* Co-ant to PIMIC porting from soc3 to soc5
*/
