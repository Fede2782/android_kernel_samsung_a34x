...
void consys_set_if_pinmux_mt6893(unsigned int enable, unsigned int curr_status,
...
int connsys_spi_master_cfg_mt6893(unsigned int curr_status, unsigned int next_status)
{
...
int connsys_a_die_cfg_mt6893(unsigned int curr_status, unsigned int next_status)
{
	int efuse_valid;
	bool adie_26m = true;
