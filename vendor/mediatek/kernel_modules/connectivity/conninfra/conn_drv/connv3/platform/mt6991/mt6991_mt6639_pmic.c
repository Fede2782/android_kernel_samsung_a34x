...
int connv3_plt_pmic_vsel_ctrl_mt6991_mt6639(u32 enable);
...
const struct connv3_platform_pmic_ops g_connv3_platform_pmic_ops_mt6991_mt6639 = {
	...
	.pmic_vsel_ctrl = connv3_plt_pmic_vsel_ctrl_mt6991_mt6639,
	...
	struct platform_device *pdev, struct connv3_dev_cb* dev_cb)
{
	...
	g_vbb2_supply = devm_regulator_get_exclusive(&pdev->dev, "conninfra_regulator");
	if (IS_ERR_OR_NULL(g_vbb2_supply)) {
